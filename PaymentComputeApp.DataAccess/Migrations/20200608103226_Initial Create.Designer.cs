...
namespace PaymentComputeApp.DataAccess.Migrations
{
    ...
    [Migration("20200608103226_Initial Create")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PaymentComputeApp.Entity.Models.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("PaymentComputeApp.Entity.Models.PaymentRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("PaymentComputeApp.Entity.Models.TaxYear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("PaymentComputeApp.Entity.Models.PaymentRecord", b =>
                {
                    b.HasOne("PaymentComputeApp.Entity.Models.Employee", "Employee")
                        .WithMany("PaymentRecords")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("PaymentComputeApp.Entity.Models.TaxYear", "TaxYear")
                        .WithMany()
